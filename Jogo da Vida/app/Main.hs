...
-- para iniciar é necessário utilizar <cabal init> e <cabal run> pelo terminal

import Graphics.Gloss
import Data.Matrix (fromLists, prettyMatrix, Matrix, toLists)
...
lerInicial fp = do
    ...
    -- ou let booleanos = map (/l -> map ( \c -> c == '#') l) linhas
...
main = do
    ...
    where 
        run m = do 
            ...
            simulate 
                (InWindow "Game of Life" tamanho (20,20)) black 12 m toPicture evolve
